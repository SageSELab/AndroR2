...
public class Script122 {
    ...
    private static final String EMAIL_TO_BE_TYPED = "test28@gmail.com";
    ...
    public void performActions() throws UiObjectNotFoundException {
        ...
        //Tap on a link
        UiObject note = mDevice.findObject(new UiSelector().resourceId("com.automattic.simplenote.debug:id/note_content").clickable(true));
        if(note.isEnabled()) {
            mDevice.click(680, 1700);
        }
    }
