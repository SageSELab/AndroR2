...
public class Script174 {
    ...
    public void testChangeText_sameActivity() {
        ...
        Url.setText("theguardian.com");

        UiObject2 Search = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "searchView")),2000);
        Search.click();
        ...
        UiObject2 Erase = mDevice.wait(Until.findObject(By.text( "Erase browsing history")),2000);
        Erase.click();
