...
public class Script7 {
    ...
    @Before
    public void startActivityFromHomeScreen() throws InterruptedException {
    ...
    public void performGUIActions() throws UiObjectNotFoundException {
        // Find proceed button
        UiObject button = mDevice.findObject(new UiSelector().className("android.widget.ImageButton"));

        // Bug-specific GUI actions
        // Click button five times
        button.click();
        button.click();
        button.click();
        button.click();
