...
public class Script168 {
    ...
    public void testChangeText_sameActivity() {
        ...
        Allow.click();
        Allow = mDevice.wait(Until.findObject(By.res("com.android.permissioncontroller", "permission_allow_always_button")),2000);
        Allow.click();
        mDevice.click(171,827);
        mDevice.click(171,827);
