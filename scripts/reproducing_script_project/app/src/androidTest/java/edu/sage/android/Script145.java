...
public class Script145 {
    ...
    public void performActions() throws UiObjectNotFoundException, InterruptedException, RemoteException {
        ...
        // click night mode
        mDevice.findObject(new UiSelector().resourceId("com.moez.QKSMS:id/night")).click();
        // select "Always on"
        ...
        // close the app from recently opened apps
        mDevice.findObject(new UiSelector().resourceId("com.android.systemui:id/dismiss_task")).click();
        // relaunch the app
