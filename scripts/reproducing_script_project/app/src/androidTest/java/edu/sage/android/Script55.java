...
public class Script55 {
    ...
    public void testChangeText_sameActivity() {
        ...
        Format.click();
        UiObject2 Categorical = mDevice.wait(Until.findObject(By.text( "Categorical")),2000);
        Categorical.click();
        UiObject2 Trait = mDevice.wait(Until.findObject(By.res( BASIC_SAMPLE_PACKAGE, "trait")),2000);
        Trait.setText("1");
        UiObject2 Categories = mDevice.wait(Until.findObject(By.res( BASIC_SAMPLE_PACKAGE, "categories")),2000);
        Categories.setText("superlongcategory1/superlongcategory2");
        UiObject2 Save = mDevice.wait(Until.findObject(By.text( "SAVE")),2000);
        Save.click();

         Plus = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "newTrait")),2000);
        Plus.click();
         Format = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "formatbox")),2000);
        Format.click();
         Categorical = mDevice.wait(Until.findObject(By.text( "Multicat")),2000);
        Categorical.click();
         Trait = mDevice.wait(Until.findObject(By.res( BASIC_SAMPLE_PACKAGE, "trait")),2000);
        Trait.setText("2");
         Categories = mDevice.wait(Until.findObject(By.res( BASIC_SAMPLE_PACKAGE, "categories")),2000);
        Categories.setText("superlongcategory1/superlongcategory2");
         Save = mDevice.wait(Until.findObject(By.text( "SAVE")),2000);
        Save.click();
