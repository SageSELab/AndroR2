...
public class Script123 {
    ...
    private static final String EMAIL_TO_BE_TYPED = "test18@gmail.com";
    ...
    public void performActions() throws UiObjectNotFoundException {
        ...
        //Click Dark at night only
        mDevice.findObject(new UiSelector().className("android.widget.CheckedTextView").index(2)).click();
        //Click Back Button
        ...
        //Click on menu view
        mDevice.findObject(new UiSelector().resourceId("com.automattic.simplenote.debug:id/menu_view_info")).click();
        //Enable markdown true
        mDevice.findObject(new UiSelector().resourceId("com.automattic.simplenote.debug:id/info_markdown_switch")).click();
        //Click on the screen
        mDevice.findObject(new UiSelector().className("android.widget.LinearLayout").index(0)).click();
        //Type text
        mDevice.findObject(new UiSelector().resourceId("com.automattic.simplenote.debug:id/note_content").clickable(true)).setText("abcd");
        //Click preview
        mDevice.findObject(new UiSelector().className("android.support.v7.app.ActionBar$Tab").index(1)).click();
    }
